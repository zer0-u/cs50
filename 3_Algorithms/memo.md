...
### print_winnter(修正)
- グラフの開始地点＝どこからも指されていないノード
    - locked[他ノード][開始地点]がすべてfalse
- 複数の人が当選する時は大丈夫なのに単一の勝者は出力できていないらしい
- 勝者が単一の場合と複数の場合を両立できない
- まず単一の場合を成り立たせてみる？
- というか問題文には「複数の開始点が存在しないと想定することができます」とあるのにcheck50に「when some pairs are tied」ってあるのはどうなんだ
- いろいろいじっていたらなぜか全部通った
    - 内側のループでconnected=trueの後にbreakやcontinueをしなくなったせい？
- 納得がいかないが正直飽きてきたし次に進みたいのでこれでよしとする
- 課題は一気に進めるべきと再認識
- 分岐と代入ってどっちが低コストなんだろう？